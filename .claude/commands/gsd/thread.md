...
5. Commit:
   ```bash
   node "C:/Users/ayush/OneDrive/Documents/Project1/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: create thread — ${ARGUMENTS}" --files ".planning/threads/${SLUG}.md"
   ```
